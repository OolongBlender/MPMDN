...
namespace ompl
{
    namespace geometric
    {
        ...
        public:
            ...
            std::string env_file = "/home/fins/planning/MPMDN-desktop/Data/obs_cloud_2000_PointNet.npy";
            std::string cloud_type = "PointNet";
            std::string state_type = "Rigidbody_2D";
            std::string Enet_file = "/home/fins/planning/MPMDN-desktop/Data/Model_MPMDN/MDN_S2D_RB_Joint_1_ckp_160_Enet_libtorch.pt";
            std::string Pnet_file = "/home/fins/planning/MPMDN-desktop/Data/Model_MPMDN/MDN_S2D_RB_Joint_1_ckp_160_Pnet_libtorch.pt";
