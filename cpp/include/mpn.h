...
namespace ompl
{
    namespace geometric
    {
        ...
        public:
            ...
            std::string env_file = "/home/fins/planning/MPMDN-desktop/Data/obs_cloud_2000.npy";
            std::string cloud_type = "CAE";
            std::string state_type = "Rigidbody_2D";
            std::string Enet_file = "/home/fins/planning/MPMDN-desktop/Data/Model_MPN/Encoder_S2D.pt";
            std::string Pnet_file = "/home/fins/planning/MPMDN-desktop/Data/Model_MPN/MPN_S2D_RB_2_ckp_460_libtorch.pt";
